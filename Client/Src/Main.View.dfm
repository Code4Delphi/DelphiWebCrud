object MainView: TMainView
  ...
  object pnBotoes: TWebPanel
    ...
    object btnList01: TWebButton
      Left = 97
      Top = 0
      Width = 168
      Height = 33
      Align = alLeft
      Caption = 'List com m'#233'todo an'#244'nimo'
      ChildOrder = 1
      ElementID = 'btnList'
      HeightPercent = 100.000000000000000000
      WidthPercent = 100.000000000000000000
      OnClick = btnList01Click
    end
    object btnList02: TWebButton
      Left = 265
      Top = 0
      Width = 97
      Height = 33
      Align = alLeft
      Caption = 'List com await'
      ChildOrder = 1
      ElementID = 'btnList02'
      HeightPercent = 100.000000000000000000
      WidthPercent = 100.000000000000000000
      OnClick = btnList02Click
    end
    object btnList03: TWebButton
      Left = 362
      Top = 0
      Width = 97
      Height = 33
  ...
  object XDataWebDataSet1: TXDataWebDataSet
    ...
    object XDataWebDataSet1Porcentagem: TIntegerField
